...
Route::middleware(['auth'])->group(function () {
    // Recurring Tasks
    Route::get('/recurring-tasks',                           [RecurringTaskWebController::class, 'index'])->name('web.recurring-tasks.index');
    ...
    // AI Suggestions
    Route::get('/suggestions',                            [SuggestionWebController::class, 'index'])->name('web.suggestions.index');
