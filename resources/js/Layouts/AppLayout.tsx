...
const NAV_ITEMS: NavItem[] = [
    ...
    { label: 'Activity Log',    href: '/my-activity',   icon: Activity,        section: 'main' },
    ...
    { label: 'Retainers & Revenue',        href: '/retainers',    icon: TrendingUp,   section: 'financial',     roles: ['ceo', 'project_manager'] },
    ...
    { label: 'GST Report (India)',     href: '/gst-report',       icon: Percent,    section: 'financial', roles: ['ceo'] },
    ...
    { label: 'Sales Pipeline',       href: '/prospects',    icon: GitBranch,    section: 'main',     roles: ['ceo', 'project_manager'] },
    { label: 'Team Capacity',       href: '/capacity',     icon: Activity,     section: 'main',     roles: ['ceo', 'project_manager'] },
    { label: 'Standup',        href: '/standup',      icon: ClipboardList, section: 'main' },
    { label: 'Client Onboarding',     href: '/onboarding',    icon: UserCheck,    section: 'main', roles: ['ceo', 'project_manager'] },
    { label: 'Goals & OKRs',          href: '/goals',            icon: Flag,        section: 'main', roles: ['ceo', 'project_manager'] },
    { label: 'Meeting Notes',      href: '/one-on-one',        icon: Users2,      section: 'main', roles: ['ceo', 'project_manager'] },
    { label: 'Issue Tracker',         href: '/issues',           icon: Bug,        section: 'main' },
