...
export default function MCPSettings({ connections, builtin_providers, global_connections, metrics, filters, organizations, diagnostics, providers_list }: Props) {
        ...
        <AppLayout title="Integrations & MCP">
            ...
            {global_connections && (
                <div className="mb-6 flex gap-1 bg-gray-100 p-1 rounded-xl w-fit">
                    ...
                    >
                        Integration Management <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-gray-200 text-gray-600">Admin</span>
                    </Button>
                </div>
            )}
            ...
            {/* Integration Management Content (Admins only) */}
            {activeTab === 'global' && global_connections && metrics && (
                ...
                <div className="mb-6 flex gap-4 border-b border-gray-200">
                    ...
                    <Button onClick={() => setGlobalTab('providers')} className={cn("pb-3 text-sm font-medium transition-colors border-b-2", globalTab === 'providers' ? "border-indigo-600 text-indigo-600" : "border-transparent text-gray-500 hover:text-gray-700")}>Integration Providers</Button>
                    ...
                    {globalTab === 'providers' && providers_list && (
                        <div className="space-y-6">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-bold text-gray-900">Manage Integration Providers</h2>
