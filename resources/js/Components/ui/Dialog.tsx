...
>(({ className, children, container, ...props }, ref) => (
    <DialogPortal container={container}>
        ...
        <DialogPrimitive.Content
            ref={ref}
            className={cn(
                'fixed inset-0 sm:inset-auto sm:left-1/2 sm:top-1/2 z-50 w-full h-full sm:h-auto sm:max-w-lg sm:-translate-x-1/2 sm:-translate-y-1/2 bg-white p-4 sm:p-6 sm:shadow-2xl border border-gray-150 duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-none sm:rounded-2xl overflow-y-auto',
                className
            )}
            {...props}
        >
